...
class RAGAgent:
    ...
    def query(self, query: str, user_id: str = "default") -> str:
        ...
        try:
            ...
            print(f"Filter search failed: {e}. Falling back to in-memory filtering.")
        ...
        You are a document analysis assistant. Use the following context to answer the user's question.
        Answer the question ONLY based on the context provided. 
        If you don't know the answer, state that you don't have enough information from the documents.
